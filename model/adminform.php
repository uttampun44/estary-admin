...
class Adminform{
    ...
    public function singupForm($firstname, $lastname, $hashed_password, $confirm_password, $email, $number, $agent_category, $address){
        ...
        if(mysqli_num_rows($stmt_check_user) > 0){
          echo "<div class='px-2 py-2'> <p class='fs-5'> Already Exists </p> </div>";
            ...
            $insert_query = "INSERT INTO estary_agent(first_name, last_name, password, confirm_password, email, phone_number, agent_category, address, Date_time)VALUES(?,?,?,?,?,?,?,?, NOW())";
